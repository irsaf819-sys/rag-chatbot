...
Original file is located at
    https://colab.research.google.com/drive/1E92OCQhnKPOgSda2SKlReuPgLtDF0XsO
"""

!pip install langchain langchain-community langchain-groq sentence-transformers chromadb pymupdf reportlab langdetect pypdf
...
if st.button("📝 Research Paper Generate Karo"):
    if st.session_state.qa and research_topic:
        with st.spinner("Agent kaam kar raha hai..."):
            ...
            # PDF banao
            pdf_path = "/content/research_paper.pdf"
...
with open("/content/app.py", "w") as f:
    f.write(app_code)
print("✅ app.py complete — sab features included!")

!pip install pyngrok -q
from pyngrok import ngrok
import subprocess, threading, os

ngrok.set_auth_token("3EjLkQKbRUynrrn3jfG1opo5XZA_4Nn7Kug22DHqRHx35JFPu")  # ngrok.com se free token lo
public_url = ngrok.connect(8501)
print(f"✅ App link: {public_url}")

subprocess.Popen(["python", "-m", "streamlit", "run", "/content/app.py",
                  "--server.port=8501", "--server.headless=true"])

from pyngrok import ngrok
import subprocess, time

ngrok.set_auth_token("3EjLkQKbRUynrrn3jfG1opo5XZA_4Nn7Kug22DHqRHx35JFPu")
...
import shutil
shutil.make_archive("/content/RAG_Chatbot_Project", 'zip', "/content")
print("✅ ZIP ready!")